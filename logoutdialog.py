...
class ShutDownDialog:
    ...
    def __init__(self):
        ...
        self.window.set_size_request(250,160)
        ...
        self.label.set_markup("<span size='11000'>Log Out Account ?</span>")
        ...
        image1 = gtk.Image()
        image1.set_from_file("/usr/share/shutdowndialog/image/logout.png")
        image1.show()
        ...
        self.box1.pack_start(self.logout_button, True, True, 5)
        self.logout_button.show()
